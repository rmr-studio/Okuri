...
INSERT INTO block_types (
    ...
    '130db1d2-2a8e-4f20-8c3d-07e69fe503c5'::uuid,
    'layout_container',
    NULL,
    'Layout Container',
        ...
        "render": {
            ...
            "components": {
                "layout": {
                    ...
                    "slotLayout": {
                        "main": {
                            "layout": {"x": 0, "y": 0, "width": 12, "height": 4, "locked": false},
                            "items": []
                        }
                    },
                    "fetchPolicy": "LAZY"
...
INSERT INTO block_types (
    ...
    'e3202dc4-5087-46c5-8b0c-28caad84c573'::uuid,
    'block_list',
    NULL,
    'Block List',
...
INSERT INTO block_types (
    ...
    '4655c164-18cb-4a38-ab5e-04c43acafa42'::uuid,
    'content_block_list',
    NULL,
    'Content Block List',
...
INSERT INTO block_types (
    ...
    '151b6bc8-6aca-47d8-8876-61dc2483e683'::uuid,
    'block_reference',
    NULL,
        ...
        "render": {
            ...
            "components": {
                "reference": {
                    ...
                    "bindings": [
                        {"prop": "text", "source": {"type": "DataPath", "path": "$.data/placeholder"}}
                    ],
                    "fetchPolicy": "LAZY"
                }
            }
...
INSERT INTO block_types (
    ...
    'b5df1b11-a9d5-423a-b23a-ce21a89a0b6a'::uuid,
        ...
        "render": {
            ...
            "components": {
                "entities": {
                    ...
                    "bindings": [
                        {"prop": "text", "source": {"type": "DataPath", "path": "$.data/emptyMessage"}}
                    ],
                    "fetchPolicy": "LAZY"
                }
            }
...
INSERT INTO block_types (
    ...
    'f6a7b8c9-d0e1-2345-f678-901234567890'::uuid,
    'note',
    NULL,
    'Note',
        ...
        "render": {
            ...
            "components": {
                "note": {
                    ...
                    "bindings": [
                        {"prop": "text", "source": {"type": "DataPath", "path": "$.data/content"}}
                    ],
                    "fetchPolicy": "LAZY"
                }
            }
        ...
        "render": {
            ...
            "components": {
                "task": {
                    ...
                    "bindings": [
                        {"prop": "text", "source": {"type": "DataPath", "path": "$.data/title"}}
                    ],
                    "fetchPolicy": "LAZY"
                }
            }
...
INSERT INTO block_types (
    ...
    NULL,
    'Postal Address',
    'Physical address for a contact or organisation.',
    NULL,
    true,
    1,
    'SOFT',
            ...
            "components": {
                "addressCard": {
                    ...
                    "bindings": [
                        {"prop": "title", "source": {"type": "DataPath", "path": "$.data/title"}},
                        {"prop": "description", "source": {"type": "DataPath", "path": "$.data/description"}},
                        {"prop": "address", "source": {"type": "DataPath", "path": "$.data/address"}}
                    ],
                    "fetchPolicy": "LAZY"
                }
            }
...
INSERT INTO block_types (
    ...
    'c9d0e1f2-a3b4-5678-9012-3456789abcde'::uuid,
    'project_overview',
    NULL,
    'Project Overview',
        ...
        "render": {
            ...
            "components": {
                "summary": {
                    ...
                    "bindings": [
                        {"prop": "text", "source": {"type": "DataPath", "path": "$.data/summary"}}
                    ],
                    "fetchPolicy": "LAZY"
                }
            }
