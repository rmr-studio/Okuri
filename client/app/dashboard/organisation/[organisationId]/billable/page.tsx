"use client";
import { useLineItem } from "@/components/feature-modules/line-item/hooks/useLineItem";
...
const LineItemPage = () => {
    ...
    if (error) return <div className="text-red-500">Failed to load line items</div>;
