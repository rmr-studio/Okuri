                    ...
                    {validationErrors.size > 0 && (
                        <div className="flex items-center gap-2 text-sm text-destructive bg-destructive/10 p-2 rounded">
                            ...
                            <span>
                                ...
                                {validationErrors.size !== 1 ? "s" : ""}. Please fix errors before
                                saving.
                            </span>
                        </div>
                    )}
                        ...
                        <div className="space-y-2">
                            ...
                            <div
                                className={cn(
                                    ...
                                    validationErrors.has(drawerState.rootBlockId) &&
                                        "border-destructive"
                                )}
                            >
                                <BlockForm
            ...
            {children.map((childId) => {
                ...
                return (
                    <Collapsible
                        key={childId}
                        open={isExpanded}
                        onOpenChange={() => toggleSection(childId)}
                    >
                        <div
                            className={cn(
                                "border rounded-lg",
                        ...
                        >
                            <CollapsibleTrigger className="flex items-center gap-2 w-full p-4 hover:bg-accent/50 transition-colors">
                                <ChevronRight
                                    className={cn(
                            ...
                            <CollapsibleContent>
                                <div className="p-4 pt-0 space-y-4">
                                    ...
                                    {hasFormFields(childBlock) && (
                                        <BlockForm
                                            blockId={childId}
                                            blockType={childBlock.block.type}
                                            mode="drawer"
                                        />
                                    )}
