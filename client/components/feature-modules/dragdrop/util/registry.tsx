...
export const DragRegistry: Record<string, DragTypeConfig> = {
    ...
    containerBlock: {
        render: (id, data) => <div className="bg-blue-200 p-2 flex">{data?.children}</div>,
    ...
    dashboard: {
        render: (id, data) => <div className="grid grid-cols-3 gap-2">{data?.children}</div>,
    ...
    invoicePage: {
        render: (id, data) => <div className="flex flex-col gap-2">{data?.children}</div>,
