...
export const renderElementsByCategory: Record<"BLOCK" | "GRID_WIDGET", RenderElementRegistry> = {
    BLOCK: blockElements,
    GRID_WIDGET: WIDGETS,
};
...
export const renderElements: RenderElementRegistry = {
    ...blockElements,
    ...Object.fromEntries(Object.entries(WIDGETS).filter(([key]) => !(key in blockElements))),
};
