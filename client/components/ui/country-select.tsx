        ...
        <Popover modal={false} open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    variant="outline"
                    className={cn(
                        "flex gap-1 py-1 h-full justify-center items-center rounded-e-none rounded-s-md border-r-0 px-3 focus:z-10",
                        className
                    )}
                    disabled={disabled}
                >
            ...
            <PopoverContent className="w-[300px] mx-4 p-0">
                <Command>
...
export const FlagComponent = ({ country, countryName }: RPNInput.FlagProps) => {
    ...
    return (
        <span className="flex justify-center h-4 w-6 overflow-hidden rounded-sm bg-foreground/20 [&_svg]:size-full">
